...
import (
	...
	"github.com/ledgerwatch/erigon/consensus/pala/thunder/bls/bn256"
	"github.com/ledgerwatch/erigon/consensus/pala/thunder/common"
...
func SigningKeyFromJSONFile(filename *string) (*SigningKey, error) {
	bytes, err := common.BytesFromJSONFile(filename, &skJSONKey)
	if err != nil {
		return nil, err
	}
